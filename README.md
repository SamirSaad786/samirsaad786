...
[![Portfolio](https://img.shields.io/badge/Portfolio-samirsaad786.github.io-222?style=flat&logo=github)](https://samirsaad786.github.io/)
...
Interactive tools built for HR practitioners, people leaders, and OD professionals.

| Tool | Description |
|------|-------------|
| [**The Hire Wire**](https://samirsaad786.github.io/the-hire-wire) | Leadership judgment game — $500K budget, 5 hires, 9 simulated months. Who you pick says everything. |
| [**The Behavior Gap**](https://samirsaad786.github.io/behavior-gap-game/) | Why training rarely changes behavior — and what the four forces that actually shape it are. |
| [**Team Dynamics Puzzle**](https://samirsaad786.github.io/Team-Dynamics/) | Belbin-informed team composition tool. Role balance is necessary. Not sufficient. |
| [**HR Sanity Check**](https://samirsaad786.github.io/hr-sanity-check/) | Diagnostic for HR practitioners and managers. Are you solving the right problems, or just staying busy? |
...
Single-file HTML5. No install. No account. Click and play.

| Game | Genre |
|------|-------|
| [**Sumi's Journal 墨の日誌**](https://samirsaad786.github.io/sumis_journal/) | Puzzle / Narrative — cyberpunk signal routing with procedural gamelan soundtrack |
...
| [**Lofi-Room**](https://samirsaad786.github.io/lofi-room/) | Ambient / Interactive — lo-fi browser room with curted mood music |
...
I also build things — simulations, diagnostic tools, browser games — that make complex people-system dynamics playable.
